...
public class PaymentPortal extends javax.swing.JFrame {
    ...
    public PaymentPortal(PaymentSystem p)
    {
        this.system = p;
    ...
    private void registerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerButtonActionPerformed
        ...
        //Register renter
        //Assumes system to enter blank data - Therefore no check for empty fields
        boolean registered = system.registerRenter(username,password);
        
        if (registered) //Successful registration
    ...
    private void clearButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clearButtonActionPerformed
        ...
        //Clear all Fields and Reset Welcome text
    ...
    private void logoutButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_logoutButtonActionPerformed
        ...
        //Reset all fields and Reset Welcome Text
        resetLogonPanel();
    ...
    private void logonButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_logonButtonActionPerformed
        ...
        billPanel.setVisible(true); //Show bill Panel           
         
        //Get values from fields
        String username = userNameField.getText();
        String password = passwordField.getText();
        
        logonPanel.setVisible(false); //Hide logon Panel
        
        
        if (system.validateRenter(username,password)) //Renter found
        {
            
            billJList.setModel(new javax.swing.AbstractListModel<String>() 
            {
                String[] strings = system.getRenterBills(username,password);
        ...
        {
            logonPanelLabel.setText("Incorrect Username/Password"); // Show proper label
    ...
    private void sortByAmountButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sortByAmountButtonActionPerformed
        ...
        if (system.validateRenter(username,password)) //Renter found
        {
            ...
            billJList.setModel(new javax.swing.AbstractListModel<String>() 
            {
                String[] strings = system.getSortedRenterBillsByAmount(username,password);
    ...
    private void sortByPaidButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sortByPaidButtonActionPerformed
        ...
        if (system.validateRenter(username,password)) //Renter found
        {
            ...
            billJList.setModel(new javax.swing.AbstractListModel<String>() 
            {
                String[] strings = system.getSortedRenterBillsByPaid(username,password);
